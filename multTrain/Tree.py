...
class DecisionTreeClassifier:
    ...
    def chooesContinueDivision(self, dataSet,col, labelSet, score_all):
        ...
        for split in splitSet:
            ...
            if len_num_ratio == 0 or rig_num_ratio == 0:
                ...
                gain = abs(score_all - (left_gain + right_gain)/IV)
            if gain > best_gain:
                best_gain = gain
                best_split = split
    ...
    #测试  
    def classify(self, test, tree,confidence = 0):
        if tree.results != None:
            ...
            return self.classify(test,branch,confidence)
